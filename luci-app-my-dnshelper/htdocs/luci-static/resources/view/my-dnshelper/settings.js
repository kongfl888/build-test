...
function helperServiceStatus() {
	return Promise.all([
		getServiceStatus(),
		getServiceStatusH(),
		L.resolveDefault(fs.exec('/bin/sh',['/usr/share/my-dnshelper/testdns']),null),
		L.resolveDefault(fs.exec('/usr/share/my-dnshelper/waiter',['--port']),null),
		L.resolveDefault(fs.exec('/usr/share/my-dnshelper/waiter',['--dns']),null)
	]);
}
...
return view.extend({
	...
	render: function(stats){
		...
		+ ' | <a href=\"https://github.com/kongfl888/luci-app-my-dnshelper/blob/main/README.cn\" target=\"_blank\" style=\"color:mediumturquoise\" >GITHUB</a>'
		+'<br/>'
		+v
		);
		...
		o = s.option(form.Flag, "block_ios", _("Block Apple iOS OTA update"));
		o.rmempty = false;
		o.default = 'false';
		...
		o.description = _("The bankruptcy company will affects web page opening!");
		o.rmempty = false;
		o.default = 'false';
		...
		o = s.option(form.Flag, "dns_detect", _("Show dns detect"), _("show on this page."));
		o.rmempty = false;
		o.default = 'false';
