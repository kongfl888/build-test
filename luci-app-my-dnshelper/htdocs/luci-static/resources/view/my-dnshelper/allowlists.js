...
return view.extend({
	...
	render: function(stats){
		...
		o.value("https://raw.githubusercontent.com/privacy-protection-tools/dead-horse/master/anti-ad-white-list.txt", _("Anti-AD-White-List"));

		o = s.option(form.Button, "bcallow");
		o.title = _("Allowed Rules");
		o.inputtitle = _("Delete All Allowed Rules");
		o.inputstyle = "apply";
		...
		o.value("https://raw.githubusercontent.com/frankwuzp/coursera-host/main/hosts", _("Thanks Coursera-Host"));

		o = s.option(form.Button, "bchosts");
		o.title = _("Hosts Data");
		o.inputtitle = _("Delete All Hosts Subscriptions");
		o.inputstyle = "apply";
